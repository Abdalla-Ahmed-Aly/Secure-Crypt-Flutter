          ...
          children: [
            ...
            ElevatedButton(
              ...
              child: SizedBox(
                ...
                child: Center(
                  child: Text(buttonText, style: TextStyle(fontSize: 20, color: ColorApp.primaryDarkColor)),
                ),
              ),
            ),
            ...
            SizedBox(height: height * 0.005),
            CustomCtrField(4, 0.16, "Encrypt will appear here", false, TextEditingController()),

            SizedBox(height: height * 0.02),
            ElevatedButton(
              onPressed: () {
                print(plaintext.text);
                print(secretKey.text);
              ...
              child: SizedBox(
                width: double.infinity,
                child: Center(
                  child: Text("Encrypt", style: TextStyle(fontSize: 20, color: ColorApp.primaryDarkColor)),
                ),
              ),
            ),
          ],
